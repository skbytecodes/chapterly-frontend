        ...
        <div>
          ...
          <section className="py-5 relative">
            <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
              <h2 className="font-manrope font-bold text-xl lg:text-2xl leading-10 text-black text-left mx-6">
                Orders
              </h2>
              <p className="mt-4 font-normal text-lg leading-8 text-gray-500 mb-11 text-left mx-6">
                    ...
                    {order?.orderedItems.map((orderItem) => (
                      <div className="flex flex-col lg:flex-row items-center py-6 border-b border-gray-200 gap-6 w-full">
                        {/* <div className="img-box max-lg:w-full">
                          <img
                            src={orderItem.book_image}
                            className="aspect-square w-full lg:max-w-[140px]"
                          />
                        </div> */}
                        <div className="img-box w-full sm:w-auto">
                          <img
                            src={orderItem.book_image}
                            className="h-[10em] lg:h-[8em] rounded-md"
                          />
                        </div>
